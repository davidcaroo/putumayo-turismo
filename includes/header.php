...
if ($is_logged_in) {
    // Obtener solo el nombre real del usuario
    $user_name = $_SESSION['nombre'] ?? $_SESSION['user_name'] ?? $_SESSION['email'] ?? '';
...
// Definir base_url para compatibilidad con código existente
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .user-indicator i.fa-chevron-down {
            font-size: 0.7rem;
        ...
        .user-dropdown:hover .user-indicator i.fa-chevron-down {
            transform: rotate(180deg);
        }
       ...
       ============================================ */
        ...
        @media (max-width: 768px) {
            ...
            .mobile-only .user-indicator:hover {
                border-color: var(--border-color);
                box-shadow: none;
            }

            .mobile-only .user-indicator i.fa-chevron-down {
                display: none;
            }
            ...
            <div class="nav-container">
                ...
                <div class="nav-logo">
                    <a href="<?php echo defined('BASE_URL') ? BASE_URL : ''; ?>index.php">
                        <img src="<?php echo defined('BASE_URL') ? BASE_URL : ''; ?>uploads/logo.png"
                ...
                <div class="nav-menu" id="nav-menu">
                    <ul class="nav-list">
                        <li class="nav-item">
                            <a href="<?php echo isset($base_url) ? $base_url : ''; ?>index.php" class="nav-link">
                                <span>Inicio</span>
                        ...
                        <li class="nav-item dropdown" id="destinos-item">
                            <a href="<?php echo isset($base_url) ? $base_url : ''; ?>destinos" class="nav-link dropdown-toggle">
                                <span>Destinos</span>
                            ...
                            <ul class="dropdown-menu">
                                <?php if (!empty($destinos_menu)): ?>
                                    <?php foreach ($destinos_menu as $destino_item): ?>
                                        <li>
                                            <a href="<?php echo isset($base_url) ? $base_url : ''; ?>destino/<?php echo htmlspecialchars($destino_item['slug']); ?>">
                                    ...
                                    <li>
                                        <a href="<?php echo isset($base_url) ? $base_url : ''; ?>destinos">
                                            <i class="fas fa-th"></i>
                        ...
                        <!-- Eventos -->
                        <li class="nav-item">
                            <a href="<?php echo isset($base_url) ? $base_url : ''; ?>eventos" class="nav-link">
                                <span>Eventos</span>
                                <i class="fas fa-chevron-right mobile-arrow"></i>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo isset($base_url) ? $base_url : ''; ?>galeria" class="nav-link">
                                <span>Galería</span>
                                <i class="fas fa-chevron-right mobile-arrow"></i>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo isset($base_url) ? $base_url : ''; ?>reservas" class="nav-link">
                                <span>Reservas</span>
                                <i class="fas fa-chevron-right mobile-arrow"></i>
                            </a>
                        </li>
                        ...
                        <?php if (!$is_logged_in): ?>
                            <li class="nav-item">
                                <a href="<?php echo isset($base_url) ? $base_url : ''; ?>login.php" class="nav-link">
                                    <span>Iniciar Sesión</span>
                                    <i class="fas fa-chevron-right mobile-arrow"></i>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo isset($base_url) ? $base_url : ''; ?>registro.php" class="btn btn-primary btn-sm" style="margin-top: 10px; width: 100%; text-align: center;">
                                    Registrarse
                                </a>
                            </li>
                        <?php endif; ?>
                ...
                <div class="nav-extra">
                    <?php if ($is_logged_in): ?>
                        <div class="user-dropdown desktop-only">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="<?php echo isset($base_url) ? $base_url : ''; ?>usuario/dashboard.php">
                                        <i class="fas fa-tachometer-alt"></i>
                                        Mi Dashboard
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo isset($base_url) ? $base_url : ''; ?>usuario/perfil.php">
                                        <i class="fas fa-user-edit"></i>
                                        Mi Perfil
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo isset($base_url) ? $base_url : ''; ?>usuario/reservas.php">
                                ...
                                <?php if (in_array($user_role, ['admin', 'superadmin'])): ?>
                                    ...
                                    <li>
                                        <a href="<?php echo isset($base_url) ? $base_url : ''; ?>admin/dashboard.php">
                                ...
                                <li>
                                    <a href="<?php echo isset($base_url) ? $base_url : ''; ?>logout.php" style="color: #dc3545;">
